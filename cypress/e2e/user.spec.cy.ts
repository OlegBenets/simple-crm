describe('User Tests', () => {
  ...
  it('should navigate to User page and add new user', () => {
      ...
      cy.get('input[placeholder="First Name"]').click({ force: true }).type('John'); 
      cy.get('input[placeholder="Last Name"]').click({ force: true }).type('Doe');
      cy.get('input[placeholder="E-Mail"]').click({ force: true }).type('johndoe@example.com'); 
      cy.get('input[placeholder="Birthdate"]').click({ force: true }).type('02.03.2001'); 
      cy.get('input[placeholder="Street + House No."]').click({ force: true }).type('Main Str 1'); 
      cy.get('input[placeholder="Zip Code"]').click({ force: true }).type('10001'); 
  ...
  it('should click on new user and edit', () => {
    ...
    cy.get('input[placeholder="First Name"]').click({ force: true }).clear().type('Joel'); 
    cy.get('input[placeholder="Last Name"]').click({ force: true }).clear().type('Miller');
    cy.get('input[placeholder="E-Mail"]').click({ force: true }).clear().type('miller@example.com'); 
    cy.get('input[placeholder="Birthdate"]').click({ force: true }).clear().type('02.03.1990'); 
  ...
  it('should click on new user and edit address', () => {
    ...
    cy.get('input[placeholder="Street + House No."]').click({ force: true }).clear().type('Main Str 3'); 
    cy.get('input[placeholder="Zip Code"]').click({ force: true }).clear().type('11111'); 
    cy.get('input[placeholder="City"]').click({ force: true }).clear().type('New Jersey');
